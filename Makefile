...
#	JENKINS_VERSION=2.190.3 go test ./e2e/... -v -count=1 -parallel 1
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestBashCompletion$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestZshCompletion$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestPowerShellCompletion$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestListComputers$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestConfigList$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestConfigGenerate$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestConfigList$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestShowCurrentConfig$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestCrumb$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestDoc$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestSearchPlugins$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestListPlugins$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestCheckUpdateCenter$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestInstallPlugin$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestDownloadPlugin$
	go test github.com/rockwang465/jenkins-cli/e2e -v -test.run ^TestListQueue$
