...
Or you can also find the latest version from the [release page](https://github.com/rockwang465/jenkins-cli/releases/latest/download/jcli-windows-amd64.zip). 
